...
snore_sources = [
    ...
    (DATA_DIR / "snore", "old_whl_s", "whl_s*.wav"),  # 注意：whltalent 已经包含 _0001 模式
...
np.savez_compressed(OUT_DIR / "train_data_v4.npz",
                    X_train=X_train, y_train=y_train,
                    X_val=X_val, y_val=y_val)
size = (OUT_DIR / "train_data_v4.npz").stat().st_size / 1024 / 1024
print(f"\n💾 保存: {OUT_DIR/'train_data_v4.npz'} ({size:.1f} MB)")
